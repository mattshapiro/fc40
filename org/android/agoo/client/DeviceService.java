...
public class DeviceService
{
  ...
  private static String a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    try
    {
      ...
      aJ.c("DeviceService", "getRemoteDeviceID--->appkey==" + paramString1 + "|appSecret==" + paramString2 + "|ttId==" + paramString3);
      ...
      while (true)
      {
        ...
        aJ.c("DeviceService", "data:[" + localResult.toString() + "]");
