...
public class PhoneHelper
{
  ...
  {
    SharedPreferences localSharedPreferences = aI.f(paramContext);
  ...
  public static String getLocalMacAddress(Context paramContext)
  {
    ...
    if ((str == null) || ("".equals(str)))
      return aI.f(paramContext).getString("mac_address", "");
    SharedPreferences.Editor localEditor = aI.f(paramContext).edit();
