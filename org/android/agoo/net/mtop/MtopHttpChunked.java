...
public class MtopHttpChunked extends bg
{
  ...
  private String a(String paramString, bb parambb)
  {
    if (parambb != null)
    {
      String str = parambb.c();
  ...
  public final void connect(Context paramContext, MtopRequest paramMtopRequest, long paramLong, bh parambh)
  {
    try
    {
      paramMtopRequest.putParams("c0", Build.BRAND);
      paramMtopRequest.putParams("c1", Build.MODEL);
      paramMtopRequest.putParams("c2", "umeng");
      paramMtopRequest.putParams("c3", "umeng");
      ...
      if (!TextUtils.isEmpty(str3))
        str1 = str1 + "&" + str3;
      super.connect(paramContext, str1, paramLong, parambh);
      return;
    }
    catch (Throwable localThrowable)
    {
      while (hasCallError());
      callError(true);
      parambh.a(504, null, localThrowable);
    }
  }
