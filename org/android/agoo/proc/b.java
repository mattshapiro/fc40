  ...
  implements Handler.Callback
{
  ...
  private static final void a(Context paramContext)
  {
    ...
    try
    {
      ...
      if (ServiceProtect.a())
      {
        aJ.c("SEService", "registerNotKill--->[current-thread-name:" + Thread.currentThread().getName() + "][action:" + str3 + "]");
  ...
  private static final void g()
  {
    try
    {
      aJ.c("SEService", "unregisterNotKill--->[current-thread-name:" + Thread.currentThread().getName() + "]");
      if (ServiceProtect.a())
        ServiceProtect.b();
      return;
    }
  ...
  public boolean hasComeFromCock(Intent paramIntent)
  {
    ...
    try
    {
      ...
      {
        aJ.c("SEService", "hasComeFromCock[action==null]or[action!=" + str2 + "]");
        return false;
      }
      String str3 = paramIntent.getStringExtra("cockroach");
      if ((TextUtils.isEmpty(str3)) || (!TextUtils.equals(str3, "cockroach-PPreotect")))
      {
        aJ.c("SEService", "hasComeFromCock[cockroach==null]or[cockroach!=" + str3 + "]");
        return false;
      }
      String str4 = paramIntent.getStringExtra("pack");
      if ((TextUtils.isEmpty(str4)) || (!TextUtils.equals(str4, getPackageName())))
      {
        aJ.c("SEService", "hasComeFromCock[pack==null] or [" + str4 + "!=" + getPackageName() + "]");
        return false;
      }
      aJ.c("SEService", "hasComeFromCock[" + str1 + "] [" + str4 + "==" + getPackageName() + "]");
    }
    catch (Throwable localThrowable)
    {
    }
  ...
  public final void onCreate()
  {
    ...
    {
      aJ.d("SEService", "se_service_handlerthread", localThrowable);
    }
  }
