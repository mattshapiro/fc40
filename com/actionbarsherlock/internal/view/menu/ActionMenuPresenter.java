  ...
  implements ActionProvider.SubUiVisibilityListener
{
  ...
  public static boolean reserveOverflow(Context paramContext)
  {
    ...
    {
      return bool2;
      bool1 = HasPermanentMenuKey.get(paramContext);
      bool2 = false;
    }
    while (bool1);
    return true;
  ...
  public boolean flagActionItems()
  {
    ...
    boolean bool3;
    label416: View localView1;
    label484: boolean bool5;
    ...
    while (true)
    {
      ...
      bool3 = false;
      break label416;
      label571: localView1.measure(m, m);
      break label484;
      label583: bool5 = false;
      break label522;
      label589: if (k + i2 > 0);
