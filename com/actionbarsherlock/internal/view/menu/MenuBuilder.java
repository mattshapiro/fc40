  ...
  implements com.actionbarsherlock.view.Menu
{
  ...
  private static final int[] sCategoryToOrder = arrayOfInt;
  ...
  public void flagActionItems()
  {
    ...
    while (true)
    {
      ...
      break;
      label123: MenuItemImpl localMenuItemImpl = (MenuItemImpl)localArrayList.get(j);
      ...
      label172: this.mActionItems.clear();
      this.mNonActionItems.clear();
