  ...
  implements MenuBuilder.ItemInvoker, MenuView
{
  ...
  private void onMeasureExactFormat(int paramInt1, int paramInt2)
  {
    ...
    int i19;
    int i20;
    label481: label869: for (int i21 = (int)(i5 * i4 / f); ; i21 = 0)
    {
      i22 = 0;
      if (i22 < i11)
        break label875;
      ...
      label745: View localView4 = getChildAt(i28);
    ...
    label592: label599: label605: label863: label875: if ((l1 & 1 << i22) == 0L);
    while (true)
    {
      i22++;
      break;
    ...
    label1038: View localView2 = getChildAt(i20);
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    while (true)
    {
      ...
      label396: i9 = 0;
      break label324;
      label402: int i13 = i11 + localLayoutParams2.leftMargin;
