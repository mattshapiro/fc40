  ...
  implements MenuBuilder.Callback, com.actionbarsherlock.view.Window.Callback, MenuPresenter.Callback, MenuItem.OnMenuItemClickListener
{
  ...
  private ViewGroup generateLayout()
  {
    ...
    if (!localTypedArray.hasValue(59))
      throw new IllegalStateException("You must use Theme.Sherlock, Theme.Sherlock.Light, Theme.Sherlock.Light.DarkActionBar, or a derivative.");
    int i;
    if (localTypedArray.getBoolean(58, false))
    {
      requestFeature(1);
    ...
    while (true)
    {
      ...
      requestFeature(8);
      break;
      label190: i = R.layout.abs__screen_action_bar;
      continue;
      label197: if ((hasFeature(10)) && (!hasFeature(1)))
        i = R.layout.abs__screen_simple_overlay_action_mode;
      else
        i = R.layout.abs__screen_simple;
    }
    label228: this.mDecor.setId(-1);
  ...
  private void installDecor()
  {
    ...
    if (this.mContentParent == null)
    {
      ...
      if (this.wActionBar != null)
      {
        ...
        label241: ActionBarContainer localActionBarContainer = (ActionBarContainer)this.mDecor.findViewById(R.id.abs__split_action_bar);
    ...
    while (true)
    {
      ...
      return;
      label347: View localView1 = this.mDecor.getChildAt(0);
      this.mDecor.removeView(localView1);
      localArrayList.add(localView1);
      m++;
      break;
      label381: View localView2 = (View)localIterator.next();
      this.mContentParent.addView(localView2);
      break label100;
      label405: int j = 0;
      break label225;
      label410: bool = this.mActivity.getTheme().obtainStyledAttributes(R.styleable.SherlockTheme).getBoolean(62, false);
      break label241;
      label434: if (bool)
  ...
  {
    int i = 0;
    label278: label286: label294: label298: label300: label305: label312: label316: 
    while (true)
    {
      int j;
      int n;
  ...
  {
    Log.d("ActionBarSherlock", "[dispatchCreateOptionsMenu] android.view.Menu: " + paramMenu);
