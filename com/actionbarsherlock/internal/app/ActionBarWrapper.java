  ...
  implements android.app.ActionBar.OnNavigationListener, android.app.ActionBar.OnMenuVisibilityListener
{
  ...
  {
    this.mMenuVisibilityListeners = new HashSet(i);
    ...
    if (this.mActionBar != null)
    {
      ...
      int k = this.mActionBar.getDisplayOptions();
    ...
    while (true)
    {
      localActionBar.setHomeButtonEnabled(i);
      return;
      label73: int j = 0;
    }
  }
    ...
    implements android.app.ActionBar.TabListener
  {
    ...
    public void onTabReselected(android.app.ActionBar.Tab paramTab, android.app.FragmentTransaction paramFragmentTransaction)
    {
      ...
      {
        boolean bool = ActionBarWrapper.this.mActivity instanceof FragmentActivity;
        android.support.v4.app.FragmentTransaction localFragmentTransaction = null;
        if (bool)
          localFragmentTransaction = ((FragmentActivity)ActionBarWrapper.this.mActivity).getSupportFragmentManager().beginTransaction().disallowAddToBackStack();
