...
public class IcsProgressBar extends View
{
  ...
  private Drawable tileify(Drawable paramDrawable, boolean paramBoolean)
  {
    if ((paramDrawable instanceof LayerDrawable))
    {
      ...
      for (int k = 0; ; k++)
      {
        if (k >= i)
        {
          ...
          int m = localLayerDrawable1.getId(j);
          Drawable localDrawable = localLayerDrawable1.getDrawable(j);
        ...
        localLayerDrawable2.setId(k, localLayerDrawable1.getId(k));
      }
    }
    if ((paramDrawable instanceof BitmapDrawable))
    {
      ...
      ((ShapeDrawable)localObject).getPaint().setShader(localBitmapShader);
      if (paramBoolean)
        localObject = new ClipDrawable((Drawable)localObject, 3, 1);
      return localObject;
    }
