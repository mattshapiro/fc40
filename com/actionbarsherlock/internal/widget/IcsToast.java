...
public class IcsToast extends Toast
{
  ...
  public static Toast makeText(Context paramContext, CharSequence paramCharSequence, int paramInt)
  {
    ...
    localTextView.setBackgroundResource(R.drawable.abs__toast_frame);
    localIcsToast.setView(localTextView);
  ...
  public void setText(CharSequence paramCharSequence)
  {
    ...
    {
      Log.e("Toast", "This Toast was not created with IcsToast.makeText", localClassCastException);
    }
  }
}
