  ...
  public void show()
  {
    ...
    if (this.mPopup.isShowing())
    {
      ...
      if (this.mDropDownWidth == i)
      {
        ...
        label48: if (!bool)
          break label146;
        PopupWindowCompat localPopupWindowCompat2 = this.mPopup;
        if (this.mDropDownWidth != i)
          break label141;
        label66: localPopupWindowCompat2.setWindowLayoutMode(i, 0);
      }
      while (true)
      {
        ...
        label141: i = 0;
        break label66;
        label146: PopupWindowCompat localPopupWindowCompat1 = this.mPopup;
        int i2 = this.mDropDownWidth;
        int i3 = 0;
        if (i2 == i)
          i3 = i;
        localPopupWindowCompat1.setWindowLayoutMode(i3, i);
        continue;
