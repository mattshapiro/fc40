...
public class ActionBarView extends AbsActionBarView
{
  ...
  public ActionBarView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    if (this.mLogo == null)
    {
      ...
      {
        int k = ResourcesCompat.loadLogoFromManifest((Activity)paramContext);
        if (k != 0)
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      break label211;
      label934: localHomeView = this.mHomeLayout;
      break label284;
      label943: i28 = View.MeasureSpec.makeMeasureSpec(localLayoutParams2.width, 1073741824);
      break label319;
      label959: i7 = 0;
      break label504;
      if (this.mListNavLayout == null)
      ...
      localView1 = this.mCustomNavView;
      break label549;
      label1221: localLayoutParams = null;
      break label580;
      label1227: if (localLayoutParams1.height != -2);
      for (i14 = 1073741824; ; i14 = -2147483648)
        break;
      label1253: i16 = -2147483648;
      break label675;
      label1261: i17 = i4;
      break label695;
      label1268: i19 = 19;
      break label718;
      label1275: int i11 = m + getChildAt(i10).getMeasuredHeight();
      if (i11 > i9)
        i9 = i11;
      i10++;
      break label841;
