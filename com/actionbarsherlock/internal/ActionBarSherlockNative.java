...
public class ActionBarSherlockNative extends ActionBarSherlock
{
  ...
  public boolean dispatchOptionsItemSelected(android.view.MenuItem paramMenuItem)
  {
    ...
    for (Object localObject = new MenuItemWrapper(paramMenuItem); ; localObject = this.mMenu.findItem(paramMenuItem))
      return callbackOptionsItemSelected((com.actionbarsherlock.view.MenuItem)localObject);
  }
    ...
    implements android.view.ActionMode.Callback
  {
    ...
    public boolean onActionItemClicked(android.view.ActionMode paramActionMode, android.view.MenuItem paramMenuItem)
    {
