  ...
  implements ActivityChooserModel.ActivityChooserModelClient
{
  ...
  private void updateAppearance()
  {
    ...
    while (true)
    {
      ...
      break;
      label168: this.mDefaultActivityButton.setVisibility(8);
    }
    label180: this.mActivityChooserContent.setBackgroundDrawable(null);
  ...
  protected void onAttachedToWindow()
  {
    ...
    try
    {
      ...
      label24: this.mIsAttachedToWindow = true;
      return;
    }
