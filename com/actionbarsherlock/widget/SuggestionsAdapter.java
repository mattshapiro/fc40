  ...
  implements View.OnClickListener
{
  ...
  public Cursor runQueryOnBackgroundThread(CharSequence paramCharSequence)
  {
    ...
    while (true)
    {
      ...
      try
      {
        label40: Cursor localCursor = getSuggestions(str, 50);
        if (localCursor != null)
        {
