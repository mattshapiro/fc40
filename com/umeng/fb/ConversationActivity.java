...
public class ConversationActivity extends FragmentActivity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    if (paramBundle == null)
    {
      ...
      if (str == null)
        str = new FeedbackAgent(this).getDefaultConversation().getId();
      this.b = FeedbackFragment.newInstance(str);
      getSupportFragmentManager().beginTransaction().add(e.q(this), this.b).commit();
    }
  }
