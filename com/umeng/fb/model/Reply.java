  ...
  implements Comparable<Reply>
{
  ...
  {
    String str1 = paramJSONObject.optString("content", "").trim();
    String str2 = paramJSONObject.optString("reply_id", "");
    String str3 = paramJSONObject.getString("type");
    String str4 = paramJSONObject.optString("content_type", null);
    long l = paramJSONObject.getLong("created_at");
    float f1 = (float)paramJSONObject.optLong("audio_duration", -1L);
    if (str4 == null)
      str4 = "text_reply";
    Reply localReply = new Reply(str1, str2, str3, l, str4, f1);
    if ("dev_reply".equals(str3))
    {
      localReply.status = "sent";
      return localReply;
    }
    localReply.status = paramJSONObject.optString("status", "not_sent");
    return localReply;
  }
