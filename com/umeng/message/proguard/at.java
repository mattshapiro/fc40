...
public class at extends au
{
  ...
  public at(int paramInt, byte[] paramArrayOfByte)
  {
    this(paramInt, paramArrayOfByte, false);
  }

  public at(int paramInt, byte[] paramArrayOfByte, boolean paramBoolean)
  {
  }
  ...
  public static byte[] a(byte[] paramArrayOfByte, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    ...
    if (paramBoolean1);
    for (at localat = new at(paramBoolean2); ; localat = new at(0, a, paramBoolean2))
    {
      long l = localat.o(paramArrayOfByte);
      if (l <= paramInt)
        break;
    ...
    return localat.l(paramArrayOfByte);
  }
  ...
  {
    return ar.f(a(paramArrayOfByte, false));
  }
  ...
  {
    return ar.f(a(paramArrayOfByte, false, true));
  }
  ...
  {
    return new at().k(paramArrayOfByte);
  }
