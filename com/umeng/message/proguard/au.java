...
public abstract class au
{
  ...
  protected au(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    this.n = paramInt1;
    this.o = paramInt2;
  ...
  {
    return b(ar.f(paramString), true);
  }

  public String j(byte[] paramArrayOfByte)
  {
    return ar.f(l(paramArrayOfByte));
  }
