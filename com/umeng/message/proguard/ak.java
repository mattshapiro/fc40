...
class ak
{
  ...
  {
    ag localag = new ag();
    localag.setOutput(paramOutputStream, "utf-8");
    localag.startDocument(null, Boolean.valueOf(true));
    localag.setFeature("http://xmlpull.org/v1/doc/features.html#indent-output", true);
    a(paramMap, null, localag);
    localag.endDocument();
  }
    ...
    throws XmlPullParserException, IOException
  {
    ...
    //   1: aconst_null
    //   2: ldc_w 282
    //   5: invokeinterface 305 3 0
    //   10: invokestatic 316	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   13: istore 5
    //   15: iload 5
    //   17: newarray int
    //   19: astore 6
    ...
    //   48: ldc_w 294
    //   51: invokevirtual 119	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   54: ifeq +117 -> 171
    //   57: aload 6
    //   59: iload 8
    //   61: aload_0
    //   62: aconst_null
    //   63: ldc 151
    //   65: invokeinterface 305 3 0
    //   70: invokestatic 316	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   73: iastore
    //   74: aload_0
    ...
    //   84: iconst_1
    //   85: if_icmpne -49 -> 36
    //   88: new 51	org/xmlpull/v1/XmlPullParserException
    //   91: dup
    ...
    //   116: invokespecial 79	org/xmlpull/v1/XmlPullParserException:<init>	(Ljava/lang/String;)V
    //   119: athrow
    //   120: astore 4
    //   122: new 51	org/xmlpull/v1/XmlPullParserException
    //   125: dup
    //   126: ldc_w 363
    //   129: invokespecial 79	org/xmlpull/v1/XmlPullParserException:<init>	(Ljava/lang/String;)V
    //   132: athrow
    //   133: astore_3
    //   134: new 51	org/xmlpull/v1/XmlPullParserException
    //   137: dup
    //   138: ldc_w 365
    //   141: invokespecial 79	org/xmlpull/v1/XmlPullParserException:<init>	(Ljava/lang/String;)V
    //   144: athrow
    //   145: astore 11
    //   147: new 51	org/xmlpull/v1/XmlPullParserException
    //   150: dup
    //   151: ldc_w 367
    //   154: invokespecial 79	org/xmlpull/v1/XmlPullParserException:<init>	(Ljava/lang/String;)V
    //   157: athrow
    //   158: astore 10
    //   160: new 51	org/xmlpull/v1/XmlPullParserException
    //   163: dup
    //   164: ldc_w 369
    //   167: invokespecial 79	org/xmlpull/v1/XmlPullParserException:<init>	(Ljava/lang/String;)V
    //   170: athrow
    //   171: new 51	org/xmlpull/v1/XmlPullParserException
    //   174: dup
    //   175: new 65	java/lang/StringBuilder
    //   178: dup
    //   179: invokespecial 66	java/lang/StringBuilder:<init>	()V
    //   182: ldc_w 371
    //   185: invokevirtual 72	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   188: aload_0
    //   189: invokeinterface 75 1 0
    //   194: invokevirtual 72	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   197: invokevirtual 76	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   200: invokespecial 79	org/xmlpull/v1/XmlPullParserException:<init>	(Ljava/lang/String;)V
    //   203: athrow
    //   204: iload 9
    //   206: iconst_3
    ...
    //   216: aload_1
    //   217: invokevirtual 119	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   220: ifeq +6 -> 226
    //   223: aload 6
    //   225: areturn
    //   226: aload_0
    ...
    //   232: ldc_w 294
    //   235: invokevirtual 119	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   238: ifeq +9 -> 247
    //   241: iinc 8 1
    //   244: goto -170 -> 74
    //   247: new 51	org/xmlpull/v1/XmlPullParserException
    //   250: dup
    //   251: new 65	java/lang/StringBuilder
    //   254: dup
    //   255: invokespecial 66	java/lang/StringBuilder:<init>	()V
    //   258: ldc 121
    ...
    //   281: invokevirtual 76	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   284: invokespecial 79	org/xmlpull/v1/XmlPullParserException:<init>	(Ljava/lang/String;)V
    //   287: athrow
    //
    // Exception table:
    //   from	to	target	type
