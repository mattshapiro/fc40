...
public final class g
{
  ...
  public byte[] b()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 158	com/umeng/analytics/g:m	()Ljava/lang/String;
    //   4: astore_1
    //   5: new 82	java/io/File
    //   8: dup
    //   9: getstatic 67	com/umeng/analytics/g:b	Landroid/content/Context;
    //   12: invokevirtual 162	android/content/Context:getFilesDir	()Ljava/io/File;
    //   15: aload_1
    //   16: invokespecial 165	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   19: astore_2
    //   20: aload_2
    //   21: invokestatic 201	com/umeng/analytics/g:a	(Ljava/io/File;)Z
    //   24: ifeq +10 -> 34
    //   27: aload_2
    //   28: invokevirtual 204	java/io/File:delete	()Z
    //   31: pop
    //   32: aconst_null
    //   33: areturn
    //   34: aload_2
    ...
    //   38: ifeq -6 -> 32
    //   41: getstatic 67	com/umeng/analytics/g:b	Landroid/content/Context;
    //   44: aload_1
    //   45: invokevirtual 208	android/content/Context:openFileInput	(Ljava/lang/String;)Ljava/io/FileInputStream;
    //   48: astore 7
    //   50: aload 7
    //   52: astore 4
    //   54: aload 4
    //   56: invokestatic 211	u/aly/bv:b	(Ljava/io/InputStream;)[B
    //   59: astore 8
    //   61: aload 4
    //   63: invokestatic 214	u/aly/bv:c	(Ljava/io/InputStream;)V
    //   66: aload 8
    //   68: areturn
    //   69: astore 6
    //   71: aconst_null
    //   72: astore 4
    //   74: aload 6
    //   76: invokevirtual 198	java/lang/Exception:printStackTrace	()V
    //   79: aload 4
    //   81: invokestatic 214	u/aly/bv:c	(Ljava/io/InputStream;)V
    //   84: aconst_null
    //   85: areturn
    //   86: astore_3
    //   87: aconst_null
    ...
    //   91: astore 5
    //   93: aload 4
    //   95: invokestatic 214	u/aly/bv:c	(Ljava/io/InputStream;)V
    //   98: aload 5
    //   100: athrow
    //   101: astore 5
    //   103: goto -10 -> 93
  ...
  public byte[] d()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 195	com/umeng/analytics/g:n	()Ljava/lang/String;
    //   4: astore_1
    //   5: new 82	java/io/File
    //   8: dup
    //   9: getstatic 67	com/umeng/analytics/g:b	Landroid/content/Context;
    ...
    //   40: aconst_null
    //   41: areturn
    //   42: getstatic 67	com/umeng/analytics/g:b	Landroid/content/Context;
    //   45: aload_1
    //   46: invokevirtual 208	android/content/Context:openFileInput	(Ljava/lang/String;)Ljava/io/FileInputStream;
    //   49: astore 10
    //   51: aload 10
    //   53: astore 8
    //   55: aload 8
    //   57: invokestatic 211	u/aly/bv:b	(Ljava/io/InputStream;)[B
    //   60: astore 11
    //   62: aload 8
    //   64: invokestatic 214	u/aly/bv:c	(Ljava/io/InputStream;)V
    //   67: aload 11
    //   69: areturn
    //   70: astore_3
    //   71: aload_2
    //   72: invokevirtual 204	java/io/File:delete	()Z
    //   75: pop
    //   76: aload_3
    //   77: invokevirtual 198	java/lang/Exception:printStackTrace	()V
    //   80: aconst_null
    //   81: areturn
    //   82: astore 9
    //   84: aconst_null
    //   85: astore 8
    //   87: aload 9
    //   89: invokevirtual 198	java/lang/Exception:printStackTrace	()V
    //   92: aload 8
    //   94: invokestatic 214	u/aly/bv:c	(Ljava/io/InputStream;)V
    //   97: goto -17 -> 80
    //   100: aload 8
    //   102: invokestatic 214	u/aly/bv:c	(Ljava/io/InputStream;)V
    //   105: aload 7
    //   107: athrow
    //   108: astore 7
    //   110: goto -10 -> 100
