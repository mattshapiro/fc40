...
public class PopularFragmentAdapter extends BaseAdapter
{
  ...
  public PopularFragmentAdapter(Context paramContext, List<DownloadMovieItem> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    while (true)
    {
      ...
      this.holder.app_download_bt.setOnClickListener(new View.OnClickListener()
      {
        ...
        {
          Myutils.getInstance();
          Myutils.istagpp = Boolean.valueOf(true);
          ...
          publicTools.popuhandler.sendMessage(localMessage);
        }
      });
      return paramView;
 ...
 * Qualified Name:     com.allinone.free.adapter.PopularFragmentAdapter
