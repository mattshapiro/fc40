...
public class App_popular_FragmentAdapter extends BaseAdapter
{
  ...
  public App_popular_FragmentAdapter(Context paramContext, List<DownloadMovieItem> paramList)
  {
    ...
    while (true)
    {
      ...
      this.holder.app_download_bt.setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          ...
          publicTools.apppopularhandler.sendMessage(localMessage);
        }
      });
      return paramView;
 ...
 * Qualified Name:     com.allinone.free.adapter.App_popular_FragmentAdapter
