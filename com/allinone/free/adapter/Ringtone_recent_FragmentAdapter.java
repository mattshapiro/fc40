...
public class Ringtone_recent_FragmentAdapter extends BaseAdapter
{
  private MyApplcation app;
  private Context ctx;
  private List<DownloadMovieItem> list;

  public Ringtone_recent_FragmentAdapter(Context paramContext, List<DownloadMovieItem> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    while (true)
    {
      ...
      try
      {
        int j = this.ctx.getSharedPreferences("ringtone_recent_data", 0).getInt("ringtone_recent_selector", -1);
        i = j;
        ...
        while (true)
        {
          ...
          localViewHolder.ringtone_download_bt.setOnClickListener(new View.OnClickListener()
          {
            public void onClick(View paramAnonymousView)
            {
              ...
              publicTools.ringtonerecenthandler.sendMessage(localMessage);
            }
          });
          return paramView;
 ...
 * Qualified Name:     com.allinone.free.adapter.Ringtone_recent_FragmentAdapter
