...
public class Mp3_popular_FragmentAdapter extends BaseAdapter
{
  private MyApplcation app;
  private Context ctx;
  private List<DownloadMovieItem> list;

  public Mp3_popular_FragmentAdapter(Context paramContext, List<DownloadMovieItem> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    while (true)
    {
      ...
      try
      {
        int j = this.ctx.getSharedPreferences("mp3_popular_data", 0).getInt("mp3_popular_selector", -1);
        i = j;
        ...
        while (true)
        {
          ...
          localViewHolder.mp3_download_bt.setOnClickListener(new View.OnClickListener()
          {
            public void onClick(View paramAnonymousView)
            {
              ...
              publicTools.mp3popularhandler.sendMessage(localMessage);
            }
          });
          return paramView;
 ...
 * Qualified Name:     com.allinone.free.adapter.Mp3_popular_FragmentAdapter
