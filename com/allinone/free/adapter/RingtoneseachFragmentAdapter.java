...
public class RingtoneseachFragmentAdapter extends BaseAdapter
{
  private MyApplcation app;
  private Context ctx;
  private List<DownloadMovieItem> list;

  public RingtoneseachFragmentAdapter(Context paramContext, List<DownloadMovieItem> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    while (true)
    {
      ...
      try
      {
        int j = this.ctx.getSharedPreferences("ringtone_search_data", 0).getInt("ringtone_search_selector", -1);
        i = j;
        ...
        while (true)
        {
          ...
          localViewHolder.ringtone_download_bt.setOnClickListener(new View.OnClickListener()
          {
            public void onClick(View paramAnonymousView)
            {
              ...
              publicTools.ringtonesearchhandler.sendMessage(localMessage);
            }
          });
          return paramView;
 ...
 * Qualified Name:     com.allinone.free.adapter.RingtoneseachFragmentAdapter
