...
public class Mp3_recent_FragmentAdapter1 extends BaseAdapter
{
  private MyApplcation app;
  private Context ctx;
  private List<DownloadMovieItem> list;

  public Mp3_recent_FragmentAdapter1(Context paramContext, List<DownloadMovieItem> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    while (true)
    {
      ...
      try
      {
        int j = this.ctx.getSharedPreferences("mp3_recent_data", 0).getInt("mp3_recent_selector", -1);
        i = j;
        ...
        while (true)
        {
          ...
          localViewHolder.mp3_download_bt.setOnClickListener(new View.OnClickListener()
          {
            public void onClick(View paramAnonymousView)
            {
              ...
              publicTools.mp3recenthandler.sendMessage(localMessage);
            }
          });
          return paramView;
 ...
 * Qualified Name:     com.allinone.free.adapter.Mp3_recent_FragmentAdapter1
