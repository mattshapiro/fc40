...
public class App_recent_FragmentAdapter extends BaseAdapter
{
  ...
  public App_recent_FragmentAdapter(Context paramContext, List<DownloadMovieItem> paramList)
  {
    ...
    while (true)
    {
      ...
      this.holder.app_download_bt.setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          ...
          publicTools.apprecenthandler.sendMessage(localMessage);
        }
      });
      return paramView;
 ...
 * Qualified Name:     com.allinone.free.adapter.App_recent_FragmentAdapter
