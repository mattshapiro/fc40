...
public class RingtoneFragmentAdapter extends BaseAdapter
{
  private MyApplcation app;
  private Context ctx;
  private List<DownloadMovieItem> list;

  public RingtoneFragmentAdapter(Context paramContext, List<DownloadMovieItem> paramList)
  {
    ...
    while (true)
    {
      ...
      localViewHolder.ringtone_download_bt.setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          ...
          publicTools.dmhandler.sendMessage(localMessage);
        }
      });
      return paramView;
 ...
 * Qualified Name:     com.allinone.free.adapter.RingtoneFragmentAdapter
